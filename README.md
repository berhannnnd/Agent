...
agent/
  ...
  security/       Tool permission rules and future safety boundaries
...
To persist runs, runtime events, approval checkpoints, approval audit, and trace spans in one local database:
