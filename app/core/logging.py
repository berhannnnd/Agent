...
from app.core.config._constants import ROOT_PATH
...
class RelativePathFormatter(logging.Formatter):
    ...
    def format(self, record):
        record.filename = os.path.relpath(record.pathname, ROOT_PATH).replace(os.sep, ".")
...
logger = setup_logger(
    ...
    filename=os.path.join(ROOT_PATH, settings.log.LOG_PATH, "logger.log"),
    stdout=True,
